...
3. Do not guess paths, addresses, repository state, tool availability, environment state, facts or solutions. Prefer live evidence and project context.
...
8. Do not ask the user to do work already available through connected tools.
...
11. Distinguish evidence and validation levels. Static/build success is not hardware/product acceptance.
...
14. Keep user-facing output focused on decisions, results, blockers and required actions; avoid unnecessary internal noise, hashes and distant future branches.
